...
to write-file
  ...
  ask turtles
   [ file-write gis:envelope-of self
     file-print "\n"
  ]
  file-close
end
...
"" ""
PENS
"Susceptible" 1.0 0 -2064490 true "" "if ticks > 0 [plot count people with [status = \"S\"] / count people * 100]"
"Infected" 1.0 0 -2674135 true "" "if ticks > 0 [plot count people with [status = \"I\"] / count people * 100]"
"Removed" 1.0 0 -11053225 true "" "if ticks > 0 [plot count people with [status = \"R\"]  / count people * 100]"
